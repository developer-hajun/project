...
public class UserService {
    ...
    public String join(String username,String passWord){
        userRepository.findByUsername(username).ifPresent(user -> {
            throw new AppException(ErrorCode.ID_DUPLICATED,username +"는 이미 있습니다.");
        });
    ...
    public String login(String username,String password){
        Users human = userRepository.findByUsername(username).orElseThrow(() -> new AppException(ErrorCode.ID_NOT_FOUND, "username이 없습니다"));
